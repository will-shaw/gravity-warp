...
public class Player : MonoBehaviour
{
    ...
    {
        if (other.gameObject.tag == "Wall" || (other.gameObject.GetComponent<BoxCollision>() && (surface == "boxM" || surface == "boxW")) || (other.collider.gameObject.GetComponent<Field>() != null && !other.collider.gameObject.GetComponent<Field>().laser))
        {
